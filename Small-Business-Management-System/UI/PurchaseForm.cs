        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (addButton.Text.Equals("Add"))
                {
                    ...
                    _purchase.PurchaseDate = Convert.ToDateTime(supplierDate.Text);
                    ...
                    _purchase.ManufactureDate = Convert.ToDateTime(manufacturedDate.Text);
                    _purchase.ExpireDate = Convert.ToDateTime(expireDate.Text);
